// define the DataReader public class
// reads time series file and serves up values
// needs to know which column of float or int data

public class DataReader { 
  0 => int _column; // set in start()
  string inFilename;
...
if(!skip)
{
  ...
  {
    <<< "non-number string found in data, line ", cnt, " = ", s+rest>>>;
    true => finished; 
    return false;
  }
}
